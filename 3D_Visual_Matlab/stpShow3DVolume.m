function stpShow3DVolume(data, dt, clim, xslices, yslices, zslices, horizons, varargin)
...
%         minTime = min(min(startTime));
        % create horizons
        [V, minTime, maxTime, newSampNum] = stpHorizontalData(data, params.startTime, dt);
    end
...
%     shading interp;
    ...
    c = colorbar('location', 'southoutside', 'position', [0.092 0.039 0.88 0.02]);
    ...
    zlabel('Time (ms)', 'fontsize', params.fontsize,'fontweight', params.fontweight, 'fontname', params.fontname);
